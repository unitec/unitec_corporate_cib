    ...
    public function footer() {
        ...
        if (defined('MDL_PERF') || (!empty($CFG->perfdebug) and $CFG->perfdebug > 7)) {
            ...
            if (defined('MDL_PERFTOFOOT') || debugging() || $CFG->perfdebug > 7) {
                $performanceinfo = unitec_corporate_cib_performance_output($perf);
            }
        }
    ...
    protected function render_custom_menu(custom_menu $menu) {
    	...
    	*/
        ...
        if (isloggedin() && $hasdisplaymycourses) {
            ...
            if ($mycoursetitle == 'module') {
				$branchlabel = '<i class="icon-briefcase"></i>'.get_string('mymodules', 'theme_unitec_corporate_cib');
				$branchtitle = get_string('mymodules', 'theme_unitec_corporate_cib');
			} else if ($mycoursetitle == 'unit') {
				$branchlabel = '<i class="icon-briefcase"></i>'.get_string('myunits', 'theme_unitec_corporate_cib');
				$branchtitle = get_string('myunits', 'theme_unitec_corporate_cib');
			} else if ($mycoursetitle == 'class') {
				$branchlabel = '<i class="icon-briefcase"></i>'.get_string('myclasses', 'theme_unitec_corporate_cib');
				$branchtitle = get_string('myclasses', 'theme_unitec_corporate_cib');
			} else {
				$branchlabel = '<i class="icon-briefcase"></i>'.get_string('mycourses', 'theme_unitec_corporate_cib');
    	...
    	*/
        ...
        if (isloggedin() && $hasdisplaymydashboard) {
            $branchlabel = '<i class="icon-dashboard"></i>'.get_string('mydashboard', 'theme_unitec_corporate_cib');
            $branchurl   = new moodle_url('/my/index.php');
