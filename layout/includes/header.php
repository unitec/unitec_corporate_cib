...
if (strpos($checkuseragent, 'MSIE 7')) {
	echo get_string('ie7message', 'theme_unitec_corporate_cib');
}?>
...
<?php
    ...
    <!-- HEADER: LOGO AREA -->
        ...
        <div class="span1 pull-right" id="profilepic">
            <p id="socialheading"><?php echo $USER->firstname; ?> (<a href="<?php echo $CFG->wwwroot.'/login/logout.php' ?>">Logout</a>)</p>
	    ...
	    <p class="loginheading">You are not logged in (<a href="<?php echo $CFG->wwwroot.'/login/index.php' ?>">Login</a>)</p>
	<?php
        }
        ...
        <p id="socialheading"><?php echo get_string('socialnetworks','theme_unitec_corporate_cib')?></p>
            <ul class="socials unstyled">
                <?php if ($haswebsite) { ?>
        ...
        <p id="socialheading"><?php echo get_string('mobileappsheading','theme_unitec_corporate_cib')?></p>
            <ul class="socials unstyled">
                <?php if ($hasios) { ?>
