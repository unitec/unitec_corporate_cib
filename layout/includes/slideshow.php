...
?>
    ...
    <?php if ($hasslide1) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide1url) { ?>
                <a href="<?php echo $slide1url ?>" class="da-link"><?php echo get_string('readmore','theme_unitec_corporate_cib')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide2) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide2url) { ?>
                <a href="<?php echo $slide2url ?>" class="da-link"><?php echo get_string('readmore','theme_unitec_corporate_cib')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide3) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide3url) { ?>
                <a href="<?php echo $slide3url ?>" class="da-link"><?php echo get_string('readmore','theme_unitec_corporate_cib')?></a>
            <?php } ?>
    ...
    <?php if ($hasslide4) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide4url) { ?>
                <a href="<?php echo $slide4url ?>" class="da-link"><?php echo get_string('readmore','theme_unitec_corporate_cib')?></a>
            <?php } ?>
