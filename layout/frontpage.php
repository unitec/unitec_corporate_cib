...
<head>
    ...
    <noscript>
			<link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/unitec_corporate_cib/style/nojs.css" />
	</noscript>
</head>
...
<div class="hidden-blocks">
    <div class="row-fluid">
        <h4><?php echo get_string('visibleadminonly', 'theme_unitec_corporate_cib') ?></h4>
            <?php
