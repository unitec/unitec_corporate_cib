...
function theme_unitec_corporate_cib_set_fontwww($css) {
    global $CFG, $PAGE;
 ...
 */
function theme_unitec_corporate_cib_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return bool
 */
function theme_unitec_corporate_cib_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 * @return string
 */
function unitec_corporate_cib_set_editicons($css, $editicons) {
	global $CFG;
	if (!empty($CFG->themedir)) {
		$editiconsurl = $CFG->themedir . '/unitec_corporate_cib/style/editicons.css'; //Pull the full path for autohide css
	} else {
		$editiconsurl = $CFG->dirroot . '/theme/unitec_corporate_cib/style/editicons.css'; //MDL-36065
	}
 ...
 */
function unitec_corporate_cib_set_autohide($css, $autohide) {
	global $CFG;
	if (!empty($CFG->themedir)) {
		$autohideurl = $CFG->themedir . '/unitec_corporate_cib/style/autohide.css'; //Pull the full path for autohide css
	} else {
		$autohideurl = $CFG->dirroot . '/theme/unitec_corporate_cib/style/autohide.css'; //MDL-36065
	}
 ...
 * @return string
 */
function unitec_corporate_cib_performance_output($param) {
 ...
 */
function unitec_corporate_cib_set_customcss($css, $customcss) {
...
function theme_unitec_corporate_cib_process_css($css, $theme) {
    ...
    $css = theme_unitec_corporate_cib_set_headingfont($css, $headingfont);
    $css = theme_unitec_corporate_cib_set_bodyfont($css, $bodyfont);
    $css = theme_unitec_corporate_cib_set_bodysize($css, $bodysize);
    $css = theme_unitec_corporate_cib_set_bodyweight($css, $bodyweight);
    ...
    $css = theme_unitec_corporate_cib_set_themecolor($css, $themecolor);
    ...
    $css = theme_unitec_corporate_cib_set_themehovercolor($css, $themehovercolor);
    ...
    $css = theme_unitec_corporate_cib_set_footercolor($css, $footercolor);
    ...
    $css = theme_unitec_corporate_cib_set_footersepcolor($css, $footersepcolor);
    ...
    $css = theme_unitec_corporate_cib_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_unitec_corporate_cib_set_footerurlcolor($css, $footerurlcolor);
    ...
    $css = theme_unitec_corporate_cib_set_footerhovercolor($css, $footerhovercolor);
...
// Set the footer heading color.
    ...
    $css = theme_unitec_corporate_cib_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_unitec_corporate_cib_set_navbarsep($css, $navbarsep);
    ...
    $css = unitec_corporate_cib_set_editicons($css, $editicons);
    ...
    $css = unitec_corporate_cib_set_autohide($css, $autohide);
    ...
    $css = unitec_corporate_cib_set_customcss($css, $customcss);

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_unitec_corporate_cib_set_logo($css, $logo);
    
    // Set the background image for the page.
    $setting = 'pagebackground';
    $pagebackground = $theme->setting_file_url($setting, $setting);
    $css = theme_unitec_corporate_cib_set_pagebackground($css, $pagebackground, $setting);
    ...
    $css = theme_unitec_corporate_cib_set_slideimage($css, $slideimage, $setting);
    ...
    $css = theme_unitec_corporate_cib_set_marketingheight($css, $marketingheight);
    ...
    $css = theme_unitec_corporate_cib_set_marketingimage($css, $marketingimage, $setting);
    ...
    // Set the font path.
    $css = theme_unitec_corporate_cib_set_fontwww($css);
    return $css;
}

function theme_unitec_corporate_cib_set_headingfont($css, $headingfont) {
...
function theme_unitec_corporate_cib_set_bodyfont($css, $bodyfont) {
...
function theme_unitec_corporate_cib_set_bodysize($css, $bodysize) {
...
function theme_unitec_corporate_cib_set_bodyweight($css, $bodyweight) {
...
function theme_unitec_corporate_cib_set_themecolor($css, $themecolor) {
...
function theme_unitec_corporate_cib_set_themehovercolor($css, $themehovercolor) {
...
function theme_unitec_corporate_cib_set_footercolor($css, $footercolor) {
...
function theme_unitec_corporate_cib_set_footertextcolor($css, $footertextcolor) {
...
function theme_unitec_corporate_cib_set_footerurlcolor($css, $footerurlcolor) {
...
function theme_unitec_corporate_cib_set_footerhovercolor($css, $footerhovercolor) {
...
function theme_unitec_corporate_cib_set_footerheadingcolor($css, $footerheadingcolor) {
...
function theme_unitec_corporate_cib_set_footersepcolor($css, $footersepcolor) {
...
function theme_unitec_corporate_cib_set_navbarsep($css, $navbarsep) {
...
function theme_unitec_corporate_cib_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_unitec_corporate_cib_set_slideimage($css, $slideimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_unitec_corporate_cib_set_marketingheight($css, $marketingheight) {
...
function theme_unitec_corporate_cib_set_marketingimage($css, $marketingimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_unitec_corporate_cib_page_init(moodle_page $page) {
    $page->requires->jquery();
    $page->requires->jquery_plugin('cslider', 'theme_unitec_corporate_cib');
    $page->requires->jquery_plugin('custom', 'theme_unitec_corporate_cib'); 
    $page->requires->jquery_plugin('alert', 'theme_unitec_corporate_cib');
    $page->requires->jquery_plugin('carousel', 'theme_unitec_corporate_cib');
    $page->requires->jquery_plugin('collapse', 'theme_unitec_corporate_cib');
    $page->requires->jquery_plugin('modal', 'theme_unitec_corporate_cib');
    $page->requires->jquery_plugin('scrollspy', 'theme_unitec_corporate_cib');
    $page->requires->jquery_plugin('tab', 'theme_unitec_corporate_cib');
    $page->requires->jquery_plugin('tooltip', 'theme_unitec_corporate_cib');
    $page->requires->jquery_plugin('transition', 'theme_unitec_corporate_cib');
    $page->requires->jquery_plugin('modernizr', 'theme_unitec_corporate_cib');  
}